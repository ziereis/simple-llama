...
def compute_rotation(distance: int, head_dim: int) -> torch.Tensor:
    """
    Compute the rotation angles for rotary positional embeddings.

    Args:
        distance (int): The distance or position in the sequence.
        head_dim (int): The dimensionality of the head.

    Returns:
        torch.Tensor: The computed rotations as a complex tensor.
    """
...
def rotate_embeddings(x: torch.Tensor, rotations: torch.Tensor) -> torch.Tensor:
    """
    Apply rotary positional embeddings to the input tensor.

    Args:
        x (torch.Tensor): The input tensor of shape (n_heads, head_dim).
        rotations (torch.Tensor): The rotations tensor of shape (1, head_dim / 2).

    Returns:
        torch.Tensor: The rotated embeddings.
    """
...
class ModelArgs:
    """
    Data class to store model hyperparameters.
    """
    dim: int = 4096
    n_layers: int = 32
    n_heads: int = 32
...
class SelfAttention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, pos: int) -> torch.Tensor:
        ...
        Args:
            ...
            pos (int): The current position in the sequence.
...
class RMSNorm(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            torch.Tensor: The output tensor after normalization.
        """
...
class FeedForward(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            torch.Tensor: The output tensor after the feedforward network.
        """
...
class EncoderBlock(nn.Module):
    ...
    def forward(self, x: torch.Tensor, pos: int) -> torch.Tensor:
        ...
        Returns:
            torch.Tensor: The output tensor after the encoder block.
        """
...
class Transformer(nn.Module):
    ...
    def forward(self, token: int, pos: int) -> torch.Tensor:
        """
        Forward pass for the transformer model.

        Args:
            token (int): The input token.
            pos (int): The current position in the sequence.

        Returns:
            torch.Tensor: The output tensor after the transformer model.
        """
